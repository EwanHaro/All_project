"""
Options:
Jouer contre un mur: tapez 1,
à lance avec Pycharm, Visual Studio ne reconnais pas le fichier audio et vidéo
"""
...
solo_ou_multi = int(input("2 joueur ou mur? 1: Mur, 2: 2 joueurs"))
...
while running:
    ...
    if not pygame.mixer.music.get_busy():
        # Recharge et redémarre la musique
